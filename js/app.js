...
function agregarPlatillo(producto){
    ...
    let {pedido} = cliente
    //validar que pedido sea mayor a 0
    if(producto.cantidad > 0){
        //comprueba si el elemento ya existe en el array
        if(pedido.some(articulo => articulo.id === producto.id)){
            //el articulo ya existe en el array, se actualiza cantidad
...
function eliminarProducto(id){
    ...
    //regresa cantidad a 0 en formulario
...
function calcularPropina(){
    ...
    //seleccionar la propina del cliente
    ...
    mostrarTotalesHTML(subtotal, total, propina);
}

function mostrarTotalesHTML(subtotal, total, propina) {
